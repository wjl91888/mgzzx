<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/BasePage.master" EnableEventValidation = "false" AutoEventWireup="true" CodeFile="DictionaryTypeWebUIDetail.aspx.cs" Inherits="DictionaryTypeWebUIDetail" %>
<asp:Content ID="ContentHeaderTitle" ContentPlaceHolderID="HeadTitleContentPlaceHolder" runat="server">字典类型详情</asp:Content>
<asp:Content ID="ContentHeader" ContentPlaceHolderID="HeaderContentPlaceHolder" runat="server">
    ...
    <script type="text/javascript">
        function OpenEditor() {
            window.location='DictionaryTypeWebUIAdd.aspx?a=e<%=AndChar%>ObjectID=<%=base.ObjectID%>';
        }
        function OpenCopyEditor() {
            window.location = 'DictionaryTypeWebUIAdd.aspx?a=c<%=AndChar%>ObjectID=<%=base.ObjectID%>';
        }
    </script>
</asp:Content>
