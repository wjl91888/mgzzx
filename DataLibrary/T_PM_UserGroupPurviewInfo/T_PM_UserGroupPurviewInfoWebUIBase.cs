/****************************************************** 
FileName:T_PM_UserGroupPurviewInfoWebUIBase.cs
******************************************************/
using System;
using System.Data;
using System.Web.UI;
...
{
    public class T_PM_UserGroupPurviewInfoWebUIBase : WebUIBase
    {
        #region 常量定义
        /// <summary>
        /// 数据类型
        /// </summary>
        public override string FilterReportType { get { return "T_PM_UserGroupPurviewInfo"; } }
        /// <summary>
        /// 当前页面所在文件路径
        /// </summary>
        ...
        /// 编辑页面文件名
        /// </summary>
        public override string WEBUI_ADD_FILENAME { get { return "T_PM_UserGroupPurviewInfoWebUIAdd.aspx"; } }
        /// <summary>
        /// 查询页面文件名
        /// </summary>
        public override string WEBUI_SEARCH_FILENAME { get { return "T_PM_UserGroupPurviewInfoWebUISearch.aspx"; } }
        /// <summary>
        /// 详情页面文件名
        /// </summary>
        public override string WEBUI_DETAIL_FILENAME { get { return "T_PM_UserGroupPurviewInfoWebUIDetail.aspx"; } }
        /// <summary>
        /// 统计页面文件名
        /// </summary>
        public override string WEBUI_STATISTIC_FILENAME { get { return "T_PM_UserGroupPurviewInfoWebUIStatistic.aspx";} }
        #endregion
        ...
        /// 添加权限
        /// </summary>
        public override string WEBUI_ADD_ACCESS_PURVIEW_ID { get { return "UGP01";} }
        /// <summary>
        /// 修改权限
        /// </summary>
        public override string WEBUI_MODIFY_ACCESS_PURVIEW_ID { get { return "UGP02";} }
        /// <summary>
        /// 浏览权限
        /// </summary>
        public override string WEBUI_SEARCH_ACCESS_PURVIEW_ID  { get { return "UGP04";} }
        /// <summary>
        /// 详情权限
        /// </summary>
        public override string WEBUI_DETAIL_ACCESS_PURVIEW_ID  { get { return "UGP05";} }
        /// <summary>
        /// 统计权限
        /// </summary>
        public override string WEBUI_STATISTIC_ACCESS_PURVIEW_ID  { get { return "UGP06";} }
        /// <summary>
        /// 删除权限
        /// </summary>
        public override string OPERATION_DELETE_PURVIEW_ID  { get { return "UGP07";} }
        /// <summary>
        /// 导出权限
        /// </summary>
        public override string OPERATION_EXPORTALL_PURVIEW_ID { get { return "UGP08";} }
        /// <summary>
        /// 导入权限
        /// </summary>
        public override string OPERATION_IMPORT_PURVIEW_ID { get { return "UGP09";} }
        #endregion
        #endregion
        ...
        /// 数据实体对象
        /// </summary>
        protected T_PM_UserGroupPurviewInfoApplicationData appData;
        /// <summary>
        /// 消息信息
        /// </summary>
        ...
        protected virtual void AddRecord()
        {
            ...
            {
                T_PM_UserGroupPurviewInfoApplicationLogic instanceT_PM_UserGroupPurviewInfoApplicationLogic
                    = (T_PM_UserGroupPurviewInfoApplicationLogic)CreateApplicationLogicInstance(typeof(T_PM_UserGroupPurviewInfoApplicationLogic));
                // 添加主表
                appData = instanceT_PM_UserGroupPurviewInfoApplicationLogic.Add(appData);
                // 批量添加相关表
                ...
                if (appData.ResultCode == ApplicationDataBase.ResultState.Succeed)
                {
                    ...
                    strMessageParam[2] = appData.UserGroupID.ToString();
        ...
        protected virtual void ModifyRecord()
        {
            if (GetModifyInputParameter())
            {
                T_PM_UserGroupPurviewInfoApplicationLogic instanceT_PM_UserGroupPurviewInfoApplicationLogic
                    = (T_PM_UserGroupPurviewInfoApplicationLogic)CreateApplicationLogicInstance(typeof(T_PM_UserGroupPurviewInfoApplicationLogic));
                // 主表修改
                appData = instanceT_PM_UserGroupPurviewInfoApplicationLogic.Modify(appData);
                // 相关表批量修改
        ...
        protected virtual void QueryRecord()
        {
            if (GetQueryInputParameter())
            {
                T_PM_UserGroupPurviewInfoApplicationLogic instanceT_PM_UserGroupPurviewInfoApplicationLogic
                    = (T_PM_UserGroupPurviewInfoApplicationLogic)CreateApplicationLogicInstance(typeof(T_PM_UserGroupPurviewInfoApplicationLogic));
                appData = instanceT_PM_UserGroupPurviewInfoApplicationLogic.Query(appData);
            }
            else
            {
                // 对错误消息进行处理
        ...
        protected virtual void DeleteRecord()
        {
            if (GetDeleteInputParameter())
            {
                T_PM_UserGroupPurviewInfoApplicationLogic instanceT_PM_UserGroupPurviewInfoApplicationLogic
                    = (T_PM_UserGroupPurviewInfoApplicationLogic)CreateApplicationLogicInstance(typeof(T_PM_UserGroupPurviewInfoApplicationLogic));
                appData = instanceT_PM_UserGroupPurviewInfoApplicationLogic.Delete(appData);
                            // 记录日志开始
                string strLogTypeID = "A02";
                strMessageParam[0] = (string)Session[ConstantsManager.SESSION_USER_LOGIN_NAME];
                strMessageParam[1] = "用户组权限";
        ...
        protected virtual void CountRecord()
        {
            if (GetCountInputParameter())
            {
                T_PM_UserGroupPurviewInfoApplicationLogic instanceT_PM_UserGroupPurviewInfoApplicationLogic
                    = (T_PM_UserGroupPurviewInfoApplicationLogic)CreateApplicationLogicInstance(typeof(T_PM_UserGroupPurviewInfoApplicationLogic));
                appData = instanceT_PM_UserGroupPurviewInfoApplicationLogic.Count(appData);
            }
            else
            {
                // 对错误消息进行处理
        ...
        protected virtual void btnAddConfirm_Click(object sender, EventArgs e)
        {
            ...
            appData = new T_PM_UserGroupPurviewInfoApplicationData();
            AddRecord();
        }
        ...
        protected virtual string AJAX_QuerySingle(string strFieldName, string strFieldValue, string strReturnFieldName)
        {
            ...
            try
            {
                T_PM_UserGroupPurviewInfoApplicationLogic instanceT_PM_UserGroupPurviewInfoApplicationLogic
                    = (T_PM_UserGroupPurviewInfoApplicationLogic)CreateApplicationLogicInstance(typeof(T_PM_UserGroupPurviewInfoApplicationLogic));
                T_PM_UserGroupPurviewInfoApplicationData appData = new T_PM_UserGroupPurviewInfoApplicationData();
                appData.Sort = false;
                ...
                switch (strFieldName)
                {
                    ...
                    case "PurviewID":
                        appData.PurviewID = Convert.ToString(strFieldValue);
                        break;
        ...
        //=====================================================================
        //  FunctionName : ValidatePurviewID
        /// <summary>
        /// 数值验证方法
        /// </summary>
        //=====================================================================        
        protected virtual ValidateData ValidatePurviewID(object objValidateData, bool boolNullable, bool boolExist)
        {
            ValidateData validateData = new ValidateData();
            try
            {
                ...
                if (DataValidateManager.ValidateIsNull(validateData.Value) == false)
                {
                    ...
                    else
                    {
                        ...
                        if (validateData.Exist == true)
                        {
                            if (AJAX_IsExist("PurviewID", validateData.Value.ToString()) == true)
                            {
                                 validateData.IsExist = true;
                                 validateData.Message = @"已存在，请再换一个。";
                                 validateData.Result = false;
        ...
        RICH.Common.Base.ApplicationData.ApplicationDataBase SetBatchOperationValue(
            ...
            T_PM_UserGroupPurviewInfoApplicationData appData,
            GridViewRow gvrTemp
        )
        {
