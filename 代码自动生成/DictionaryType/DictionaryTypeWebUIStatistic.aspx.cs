...
public partial class DictionaryTypeWebUIStatistic : RICH.Common.BM.DictionaryType.DictionaryTypeWebUI
{
    ...
    private string GetTableCaption()
    {
        ...
        sbCaption.Append(@"字典类型统计（"+CountField.SelectedItem.Text+"）");
