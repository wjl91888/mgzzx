...
<div id="AppDetailPage">
    <asp:Repeater ID="rptDetail" runat="server">
        <ItemTemplate>
            ...
            <div id="XMContainer" runat="server" Visible="false" class="row">
            ...
            <div id="FFGZNYContainer" runat="server" Visible="false" class="row">
            ...
            <div id="JCGZContainer" runat="server" Visible="false" class="row">
            ...
            <div id="JSDJGZContainer" runat="server" Visible="false" class="row">
            ...
            <div id="ZWGZContainer" runat="server" Visible="false" class="row">
            ...
            <div id="JBGZContainer" runat="server" Visible="false" class="row">
            ...
            <div id="JKDQJTContainer" runat="server" Visible="false" class="row">
            ...
            <div id="JKTSGWJTContainer" runat="server" Visible="false" class="row">
            ...
            <div id="GLGZContainer" runat="server" Visible="false" class="row">
            ...
            <div id="XJGZContainer" runat="server" Visible="false" class="row">
            ...
            <div id="TGBFContainer" runat="server" Visible="false" class="row">
            ...
            <div id="DHFContainer" runat="server" Visible="false" class="row">
            ...
            <div id="DSZNFContainer" runat="server" Visible="false" class="row">
            ...
            <div id="FNWSHLFContainer" runat="server" Visible="false" class="row">
            ...
            <div id="HLFContainer" runat="server" Visible="false" class="row">
            ...
            <div id="JJContainer" runat="server" Visible="false" class="row">
            ...
            <div id="JTFContainer" runat="server" Visible="false" class="row">
            ...
            <div id="JHLGZContainer" runat="server" Visible="false" class="row">
            ...
            <div id="JTContainer" runat="server" Visible="false" class="row">
            ...
            <div id="BFContainer" runat="server" Visible="false" class="row">
            ...
            <div id="QTBTContainer" runat="server" Visible="false" class="row">
            ...
            <div id="DFXJTContainer" runat="server" Visible="false" class="row">
            ...
            <div id="YFXContainer" runat="server" Visible="false" class="row">
            ...
            <div id="QTKKContainer" runat="server" Visible="false" class="row">
            ...
            <div id="SYBXContainer" runat="server" Visible="false" class="row">
            ...
            <div id="SDNQFContainer" runat="server" Visible="false" class="row">
            ...
            <div id="SDSContainer" runat="server" Visible="false" class="row">
            ...
            <div id="YLBXContainer" runat="server" Visible="false" class="row">
            ...
            <div id="YLIBXContainer" runat="server" Visible="false" class="row">
            ...
            <div id="YSSHFContainer" runat="server" Visible="false" class="row">
            ...
            <div id="ZFGJJContainer" runat="server" Visible="false" class="row">
            ...
            <div id="KFXContainer" runat="server" Visible="false" class="row">
            ...
            <div id="SFGZContainer" runat="server" Visible="false" class="row">
            ...
            <div id="GZKKSMContainer" runat="server" Visible="false" class="row">
