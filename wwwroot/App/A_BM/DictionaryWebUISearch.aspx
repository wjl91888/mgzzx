...
<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AppBasePage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="DictionaryWebUISearch.aspx.cs" Inherits="App.DictionaryWebUISearch" %>
    ...
    <telerik:RadAjaxManagerProxy ID="ramDictionary" runat="server">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="btnFirstPage">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="rptList" LoadingPanelID="ralpDictionary" />
        ...
        <ItemTemplate>
            <div class="list-group" style="margin:0 0 5px 0;">
                <div class="list-group-item">
                    <a href='<%# "DictionaryWebUIDetail.aspx?p={0}{1}ObjectID={2}".FormatInvariantCulture(this.Page.Request["p"], AndChar ,GetValue(DataBinder.Eval(Container.DataItem, "ObjectID"), null))%>'><h4 class="list-group-item-heading">
