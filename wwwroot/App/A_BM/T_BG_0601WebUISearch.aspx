    ...
    <asp:Repeater ID="rptList" runat="server">
        <ItemTemplate>
            <div class="list-group" style="margin:0 0 5px 0;">
                <a href='T_BG_0601WebUIDetail.aspx?ObjectID=<%# GetValue(DataBinder.Eval(Container.DataItem, "ObjectID"), null)%>'
                    ...
                    <h6 class="col-sm-4 col-xs-4 text-right" style="margin:0;">
