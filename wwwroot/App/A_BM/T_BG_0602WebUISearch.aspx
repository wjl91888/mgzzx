...
<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AppBasePage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="T_BG_0602WebUISearch.aspx.cs" Inherits="App.T_BG_0602WebUISearch" %>
    ...
    <telerik:RadAjaxManagerProxy ID="ramT_BG_0602" runat="server">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="btnFirstPage">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="rptList" LoadingPanelID="ralpT_BG_0602" />
        ...
        <ItemTemplate>
            <div class="list-group" style="margin:0 0 5px 0;">
                <div class="list-group-item">
                    <a href='<%# "T_BG_0602WebUIDetail.aspx?p={0}{1}ObjectID={2}".FormatInvariantCulture(this.Page.Request["p"], AndChar ,GetValue(DataBinder.Eval(Container.DataItem, "ObjectID"), null))%>'><h4 class="list-group-item-heading">
                        <%# GetValue(DataBinder.Eval(Container.DataItem, "LMM"), null)%></h4></a>
