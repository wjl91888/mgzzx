                            ...
                            <tbody>
                                ...
                                <tr bgcolor="#ffffff">
                                    ...
                                    <td align="left" width="320" height="28">
                                        ...
                                        &nbsp;&nbsp;请输入<asp:Image ID="imgIdentifyCode" runat="server" Height="16px" />
                                    </td>
                                </tr>
                                <tr bgcolor="#ffffff">
                                    <td align="middle" bgcolor="#ffffff" colspan="2" height="38">
                                        <asp:Button ID="btnLogin" runat="server" Text="确定登陆" CssClass="login" OnClick="btnLogin_Click" />
                                        &nbsp;&nbsp;
                                        <asp:Button ID="btnRefresh" runat="server" Text="刷新本页" CssClass="login" />
