                ...
                <div id="ListControl" runat="server" class="main">
                    <div class="list" id="divList" runat="server">
                        ...
                        Visible = "false">
                               ...
                               <%# DataBinder.Eval(Container.DataItem, "DXXFJ") == DBNull.Value ? "" : "<a href='../../PreviewDocument/PreviewDocument.aspx?a=d"+ AndChar +"file=" + DataBinder.Eval(Container.DataItem, "DXXFJ") + "' target='_blank'>下载</a>"%>
