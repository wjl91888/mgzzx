...
<asp:Content ID="ContentHeaderTitle" ContentPlaceHolderID="HeadTitleContentPlaceHolder" runat="server">字典信息查询</asp:Content>
            ...
            <div id="advancesearchpage" runat="server" class="advancesearchpage">
                ...
                <div class="main">
                    <div class="block">
                       ...
                       <div class="content clearboth" id="SJDM_Area" runat="server">
                           ...
                           <div class="fieldinput alignright width100per">
                                   <asp:CheckBox ID="chkShowSubItemSJDM" runat="server" Text = "包含子（下级）" Checked="true" CssClass="needrefresh" />
                   ...
                   <div class="contentshow">
                       <div class="field">
                           <div class="fieldcheck">
                               <asp:CheckBox ID="chkShowDM" runat="server"  CssClass="needrefresh" Text = "代码" 
                                         Checked="true" />
                   ...
                   <div class="contentshow">
                       <div class="field">
                           <div class="fieldcheck">
                               <asp:CheckBox ID="chkShowLX" runat="server"  CssClass="needrefresh" Text = "类型" 
                                         Checked="true" />
                   ...
                   <div class="contentshow">
                       <div class="field">
                           <div class="fieldcheck">
                               <asp:CheckBox ID="chkShowMC" runat="server"  CssClass="needrefresh" Text = "名称" 
                                         Checked="true" />
                   ...
                   <div class="contentshow">
                       <div class="field">
                           <div class="fieldcheck">
                               <asp:CheckBox ID="chkShowSJDM" runat="server"  CssClass="needrefresh" Text = "上级代码" 
                                         Checked="true" />
            ...
            <div id="listpage" runat="server" class="listpage">
               <div id="toptoolsbar" runat="server" class="toptoolsbar">
                ...
                <div class="quicksearch">
                    <input type="button" id="btnAddItem" runat="server" value="添加" onclick="OpenWindow('DictionaryWebUIAdd.aspx?a=a',770,600,window);" class="button" />

                     <input type="button" id="btnStatisticItem" runat="server" value="统计" onclick="OpenWindow('DictionaryWebUIStatistic.aspx',770,600,window);" class="button" />
                ...
                <div id="ListControl" runat="server" class="main">
                    <div class="list" id="divList" runat="server">
                        ...
                        Visible = "true">
                                ...
                                <HeaderTemplate>
                                    代码<asp:LinkButton ID="btnSortDM" runat="server" CommandArgument="DM"
                        ...
                        Visible = "true">
                                ...
                                <HeaderTemplate>
                                    类型<asp:LinkButton ID="btnSortLX" runat="server" CommandArgument="LX"
                                        CommandName="DescSort" Text="▲" OnClick="btnSort_Click" CssClass="button"></asp:LinkButton>
                                </HeaderTemplate>
                                <ItemTemplate>
                        ...
                        Visible = "true">
                           ...
                           <asp:TemplateField HeaderText="上级代码" 
                        Visible = "true">
                                <ItemStyle CssClass="fieldinput" HorizontalAlign="Center" />
                                <HeaderStyle CssClass="fieldname" />
                                <FooterStyle CssClass="fieldname" />
                                ...
                                <HeaderTemplate>
                                    上级代码<asp:LinkButton ID="btnSortSJDM" runat="server" CommandArgument="SJDM"
                                        CommandName="DescSort" Text="▲" OnClick="btnSort_Click" CssClass="button"></asp:LinkButton>
                                </HeaderTemplate>
                                <ItemTemplate>
