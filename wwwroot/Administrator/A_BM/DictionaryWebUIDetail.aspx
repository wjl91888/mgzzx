<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/BasePage.master" EnableEventValidation = "false" AutoEventWireup="true" CodeFile="DictionaryWebUIDetail.aspx.cs" Inherits="DictionaryWebUIDetail" %>
<asp:Content ID="ContentHeaderTitle" ContentPlaceHolderID="HeadTitleContentPlaceHolder" runat="server">字典信息详情</asp:Content>
<asp:Content ID="ContentHeader" ContentPlaceHolderID="HeaderContentPlaceHolder" runat="server">
    ...
    <script type="text/javascript">
        function OpenEditor() {
            window.location='DictionaryWebUIAdd.aspx?a=e<%=AndChar%>ObjectID=<%=base.ObjectID%>';
        }
        function OpenCopyEditor() {
            window.location = 'DictionaryWebUIAdd.aspx?a=c<%=AndChar%>ObjectID=<%=base.ObjectID%>';
        }
    </script>
</asp:Content>
