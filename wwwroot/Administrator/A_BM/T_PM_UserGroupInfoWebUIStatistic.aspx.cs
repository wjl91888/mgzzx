...
public partial class T_PM_UserGroupInfoWebUIStatistic : RICH.Common.BM.T_PM_UserGroupInfo.T_PM_UserGroupInfoWebUI
{
    ...
    private string GetTableCaption()
    {
        ...
        sbCaption.Append(@"用户组信息统计（"+CountField.SelectedItem.Text+"）");
