...
<asp:Content ID="ContentHeader" ContentPlaceHolderID="HeaderContentPlaceHolder" runat="server">
    ...
    <script type="text/javascript">
        function OpenEditor() {
            window.location='FilterReportWebUIAdd.aspx?a=e<%=AndChar%>ObjectID=<%=base.ObjectID%>';
        }
        function OpenCopyEditor() {
            window.location = 'FilterReportWebUIAdd.aspx?a=c<%=AndChar%>ObjectID=<%=base.ObjectID%>';
        }
    </script>
</asp:Content>
