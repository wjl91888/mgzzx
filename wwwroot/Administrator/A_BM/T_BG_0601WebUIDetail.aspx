                    ...
                    <div ID="ControlContainer" runat="server" class="print">
                        <asp:GridView ID="gvPrint" runat="server" AutoGenerateColumns="False" CellSpacing="0" CellPadding="0" HorizontalAlign="Center" BorderWidth="0" onrowdatabound="gvPrint_RowDataBound">
                            <Columns>
                               ...
                               <%# DataBinder.Eval(Container.DataItem, "XXTPDZ") == DBNull.Value ? "" : "<a href='../../PreviewDocument/PreviewDocument.aspx?a=d"+ AndChar +"file=" + DataBinder.Eval(Container.DataItem, "XXTPDZ") + "' target='_blank'>下载</a>"%>
                               <%# DataBinder.Eval(Container.DataItem, "XXTPDZ") == DBNull.Value ? "" : "<a href='../../PreviewDocument/PreviewDocument.aspx?file=" + DataBinder.Eval(Container.DataItem, "XXTPDZ") + "' target='_blank'>预览</a>"%>
                               ...
                               <%# DataBinder.Eval(Container.DataItem, "FJXZDZ") == DBNull.Value ? "" : "<a href='../../PreviewDocument/PreviewDocument.aspx?a=d"+ AndChar +"file=" + DataBinder.Eval(Container.DataItem, "FJXZDZ") + "' target='_blank'>下载</a>"%>
