/****************************************************** 
FileName:DictionaryTypeWebUISearch.aspx.cs
******************************************************/
using System;
using System.Data;
using System.Web.UI;
...
public partial class DictionaryTypeWebUISearch : RICH.Common.BM.DictionaryType.DictionaryTypeWebUI
{
    ...
    protected override void Page_Load(object sender, EventArgs e)
    {
        ...
        ramDictionaryType.AjaxRequest += AjaxManager_AjaxRequest;
    ...
    protected override void gvList_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            e.Row.Attributes.Add("ondblclick", "OpenWindow('DictionaryTypeWebUIAdd.aspx?ObjectID={0}{1}a=v',770,600,window);return false;".FormatInvariantCulture(strObjectID,  AndChar));
        }
    }
