<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/BasePage.master" EnableEventValidation = "false" validateRequest="false" AutoEventWireup="true" CodeFile="DictionaryTypeWebUISearch.aspx.cs" Inherits="DictionaryTypeWebUISearch" %>
...
<asp:Content ID="ContentHeaderTitle" ContentPlaceHolderID="HeadTitleContentPlaceHolder" runat="server">字典类型查询</asp:Content>
<asp:Content ID="ContentMain" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    function RefreshGrid() {
        $find("<%= ramDictionaryType.ClientID %>").ajaxRequest("Refresh");
    }
    ...
    <telerik:RadAjaxManager ID="ramDictionaryType" runat="server">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="btnOperate">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="SearchPageTopToolBar" LoadingPanelID="ralpDictionaryType" />
                    <telerik:AjaxUpdatedControl ControlID="ListControl" LoadingPanelID="ralpDictionaryType" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            ...
            <telerik:AjaxSetting AjaxControlID="ramDictionaryType">
                <UpdatedControls>
                ...
                <div id="ListControl" runat="server" class="main">
                    <div class="list" id="divList" runat="server">
                        <asp:GridView ID="gvList" runat="server" ShowFooter="true" AutoGenerateColumns="False" CssClass="table" CellPadding="5" Width="100%" BorderWidth="0px" HorizontalAlign="Center" OnRowDataBound="gvList_RowDataBound">
                           ...
                           <asp:TemplateField HeaderText="类型代码" 
                        Visible = "true">
