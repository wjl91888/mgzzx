...
<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AppBasePage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="T_PM_UserGroupInfoWebUISearch.aspx.cs" Inherits="App.T_PM_UserGroupInfoWebUISearch" %>
    ...
    <telerik:RadAjaxManagerProxy ID="ramT_PM_UserGroupInfo" runat="server">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="btnFirstPage">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="rptList" LoadingPanelID="ralpT_PM_UserGroupInfo" />
        ...
        <ItemTemplate>
            <div class="list-group" style="margin:0 0 5px 0;">
                <div class="list-group-item">
                    <a href='<%# "T_PM_UserGroupInfoWebUIDetail.aspx?p={0}{1}ObjectID={2}".FormatInvariantCulture(this.Page.Request["p"], AndChar ,GetValue(DataBinder.Eval(Container.DataItem, "ObjectID"), null))%>'><h4 class="list-group-item-heading">
                        <%# GetValue(DataBinder.Eval(Container.DataItem, "UserGroupName"), null)%></h4></a>
