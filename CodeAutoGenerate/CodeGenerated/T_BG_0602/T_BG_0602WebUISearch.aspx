<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/BasePage.master" EnableEventValidation = "false" validateRequest="false" AutoEventWireup="true" CodeFile="T_BG_0602WebUISearch.aspx.cs" Inherits="T_BG_0602WebUISearch" %>
...
<asp:Content ID="ContentHeaderTitle" ContentPlaceHolderID="HeadTitleContentPlaceHolder" runat="server">公共信息栏目查询</asp:Content>
<asp:Content ID="ContentMain" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    function RefreshGrid() {
        $find("<%= ramT_BG_0602.ClientID %>").ajaxRequest("Refresh");
    }
    ...
    <telerik:RadAjaxManager ID="ramT_BG_0602" runat="server">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="btnOperate">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="SearchPageTopToolBar" LoadingPanelID="ralpT_BG_0602" />
                    <telerik:AjaxUpdatedControl ControlID="ListControl" LoadingPanelID="ralpT_BG_0602" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            ...
            <telerik:AjaxSetting AjaxControlID="ramT_BG_0602">
                <UpdatedControls>
        ...
        <center>
            ...
            <div id="advancesearchpage" runat="server" class="advancesearchpage">
                ...
                <div class="main">
                    <div class="block">
                       ...
                       <div class="content" id="LMM_Area" runat="server">
                           ...
                           <div class="fieldinput">
                             ...
                             <asp:TextBox ID="LMM" runat="server" CssClass="input needrefresh"></asp:TextBox>
                       ...
                       <div class="content" id="SJLMH_Area" runat="server">
                           ...
                           <div class="fieldinput">
                             ...
                             <asp:DropDownList ID="SJLMH" runat="server" CssClass="input needrefresh"></asp:DropDownList>
                       ...
                       <div class="content" id="LMLBYS_Area" runat="server">
                           ...
                           <div class="fieldinput">
                             ...
                             <asp:DropDownList ID="LMLBYS" runat="server" CssClass="input needrefresh"></asp:DropDownList>
                                        
                           </div>
                       </div>
  
                       <div class="content" id="LMNR_Area" runat="server">
                           <div class="field">
                               <div class="fieldname">
                                            栏目显示内容
                               </div>
                           ...
                           <div class="fieldinput">
                             ...
                             <asp:TextBox ID="LMNR" runat="server" CssClass="input needrefresh"></asp:TextBox>
                   ...
                   <div ID="chkShowLMM_Area" runat="server"   class="contentshow">
                       <div class="field">
                           <div class="fieldcheck">
                               <asp:CheckBox ID="chkShowLMM" runat="server"  CssClass="needrefresh" Text = "栏目名" 
                                         Checked="true" />
                               <asp:TextBox ID="txtLMMColumnIndex" runat="server" Width="13" MaxLength="2" Visible = "False"></asp:TextBox>
                           </div>
                       </div>
                   </div>
                    
                   <div ID="chkShowSJLMH_Area" runat="server"   class="contentshow">
                       <div class="field">
                           <div class="fieldcheck">
                               <asp:CheckBox ID="chkShowSJLMH" runat="server"  CssClass="needrefresh" Text = "上级栏目" 
                                         Checked="true" />
                               <asp:TextBox ID="txtSJLMHColumnIndex" runat="server" Width="13" MaxLength="2" Visible = "False"></asp:TextBox>
                           </div>
                       </div>
                   </div>
                    
                   <div ID="chkShowLMNR_Area" runat="server"   class="contentshow">
                       <div class="field">
                           <div class="fieldcheck">
                               <asp:CheckBox ID="chkShowLMNR" runat="server"  CssClass="needrefresh" Text = "栏目显示内容" 
                                         Checked="true" />
                               <asp:TextBox ID="txtLMNRColumnIndex" runat="server" Width="13" MaxLength="2" Visible = "False"></asp:TextBox>
                           </div>
                       </div>
                   </div>
                    
                   <div ID="chkShowLMLBYS_Area" runat="server"   class="contentshow">
                       <div class="field">
                           <div class="fieldcheck">
                               <asp:CheckBox ID="chkShowLMLBYS" runat="server"  CssClass="needrefresh" Text = "栏目列表样式" 
                                         Checked="true" />
                               <asp:TextBox ID="txtLMLBYSColumnIndex" runat="server" Width="13" MaxLength="2" Visible = "False"></asp:TextBox>
                           </div>
                       </div>
                   </div>
                    
                   <div ID="chkShowLMH_Area" runat="server"   class="contentshow">
                       <div class="field">
                           <div class="fieldcheck">
                               <asp:CheckBox ID="chkShowLMH" runat="server"  CssClass="needrefresh" Text = "栏目号" 
                                         Checked="true" />
                               <asp:TextBox ID="txtLMHColumnIndex" runat="server" Width="13" MaxLength="2" Visible = "False"></asp:TextBox>
                           </div>
                       </div>
                   </div>
                    
                   <div ID="chkShowSFLBLM_Area" runat="server"   class="contentshow">
                       <div class="field">
                           <div class="fieldcheck">
                               <asp:CheckBox ID="chkShowSFLBLM" runat="server"  CssClass="needrefresh" Text = "列表内容栏目" 
                                         Checked="true" />
                               <asp:TextBox ID="txtSFLBLMColumnIndex" runat="server" Width="13" MaxLength="2" Visible = "False"></asp:TextBox>
                           </div>
                       </div>
                   </div>
                    
                   <div ID="chkShowSFWBURL_Area" runat="server"   class="contentshow">
                       <div class="field">
                           <div class="fieldcheck">
                               <asp:CheckBox ID="chkShowSFWBURL" runat="server"  CssClass="needrefresh" Text = "外部栏目" 
                                         Checked="true" />
                               <asp:TextBox ID="txtSFWBURLColumnIndex" runat="server" Width="13" MaxLength="2" Visible = "False"></asp:TextBox>
                           </div>
                       </div>
                   </div>
                ...
                <div id="ListControl" runat="server" class="main">
                    <div class="list" id="divList" runat="server">
                        <asp:GridView ID="gvList" runat="server" ShowFooter="true" AutoGenerateColumns="False" CssClass="table" CellPadding="5" Width="100%" BorderWidth="0px" HorizontalAlign="Center" OnRowDataBound="gvList_RowDataBound">
                           ...
                           <asp:TemplateField HeaderText="栏目号" 
                        Visible = "true">
                                ...
                                <HeaderTemplate>
                                    栏目号<asp:LinkButton ID="btnSortLMH" runat="server" CommandArgument="LMH"
                        ...
                        Visible = "true">
                                ...
                                <HeaderTemplate>
                                    栏目名<asp:LinkButton ID="btnSortLMM" runat="server" CommandArgument="LMM"
                                        CommandName="DescSort" Text="▲" OnClick="btnSort_Click" CssClass="button"></asp:LinkButton>
                                </HeaderTemplate>
                                <ItemTemplate>
                           ...
                           <asp:TemplateField HeaderText="上级栏目" 
                        Visible = "true">
                                <ItemStyle CssClass="fieldinput" HorizontalAlign="Center" />
                                <HeaderStyle CssClass="fieldname" />
                                <FooterStyle CssClass="fieldname" />
                                ...
                                <HeaderTemplate>
                                    上级栏目<asp:LinkButton ID="btnSortSJLMH" runat="server" CommandArgument="SJLMH"
                                        CommandName="DescSort" Text="▲" OnClick="btnSort_Click" CssClass="button"></asp:LinkButton>
                                </HeaderTemplate>
                                <ItemTemplate>
                           ...
                           <asp:TemplateField HeaderText="栏目显示内容" 
                        Visible = "false">
                                <ItemStyle CssClass="fieldinput" HorizontalAlign="Center" />
                                <HeaderStyle CssClass="fieldname" />
                                <FooterStyle CssClass="fieldname" />
                                ...
                                <ItemTemplate>
                                        ...
                                        <%# "<a href=\"#\" style=\"cursor:pointer;text-decoration:none;\" onclick=\"OpenWindow('T_BG_0602WebUIDetail.aspx?ObjectID=" + DataBinder.Eval(Container.DataItem, "ObjectID") + "',770,600,window);\">点击查看</a>"%>
                           ...
                           <asp:TemplateField HeaderText="栏目列表样式" 
                        Visible = "true">
                                <ItemStyle CssClass="fieldinput" HorizontalAlign="Center" />
                                <HeaderStyle CssClass="fieldname" />
                                <FooterStyle CssClass="fieldname" />
                                ...
                                <HeaderTemplate>
                                    栏目列表样式<asp:LinkButton ID="btnSortLMLBYS" runat="server" CommandArgument="LMLBYS"
                                        CommandName="DescSort" Text="▲" OnClick="btnSort_Click" CssClass="button"></asp:LinkButton>
                                </HeaderTemplate>
                                <ItemTemplate>
                           ...
                           <asp:TemplateField HeaderText="列表内容栏目" 
                        Visible = "true">
                                <ItemStyle CssClass="fieldinput" HorizontalAlign="Center" />
                                <HeaderStyle CssClass="fieldname" />
                                <FooterStyle CssClass="fieldname" />
                                ...
                                <HeaderTemplate>
                                    列表内容栏目<asp:LinkButton ID="btnSortSFLBLM" runat="server" CommandArgument="SFLBLM"
                                        CommandName="DescSort" Text="▲" OnClick="btnSort_Click" CssClass="button"></asp:LinkButton>
                                </HeaderTemplate>
                                <ItemTemplate>
                           ...
                           <asp:TemplateField HeaderText="外部栏目" 
                        Visible = "true">
                                <ItemStyle CssClass="fieldinput" HorizontalAlign="Center" />
                                <HeaderStyle CssClass="fieldname" />
                                <FooterStyle CssClass="fieldname" />
                                ...
                                <HeaderTemplate>
                                    外部栏目<asp:LinkButton ID="btnSortSFWBURL" runat="server" CommandArgument="SFWBURL"
                                        CommandName="DescSort" Text="▲" OnClick="btnSort_Click" CssClass="button"></asp:LinkButton>
                                </HeaderTemplate>
                                <ItemTemplate>
