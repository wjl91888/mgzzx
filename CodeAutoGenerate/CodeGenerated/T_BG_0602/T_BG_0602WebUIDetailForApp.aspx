    ...
    <asp:Repeater ID="rptDetail" runat="server">
        <ItemTemplate>
            ...
            <div id="LMHContainer" runat="server" class="row">
                <div id="LMHCaption" runat="server" class="fontbold col-xs- paddingleft0">栏目号</div>
                <div id="LMHContent" runat="server" class="col-xs-">
            ...
            <div id="LMMContainer" runat="server" class="row">
                <div id="LMMCaption" runat="server" class="fontbold col-xs- paddingleft0">栏目名</div>
                <div id="LMMContent" runat="server" class="col-xs-">
            ...
            <div id="SJLMHContainer" runat="server" class="row">
                <div id="SJLMHCaption" runat="server" class="fontbold col-xs- paddingleft0">上级栏目</div>
                <div id="SJLMHContent" runat="server" class="col-xs-">
            ...
            <div id="LMTPContainer" runat="server" class="row">
                <div id="LMTPCaption" runat="server" class="fontbold col-xs- paddingleft0">栏目图片</div>
                <div id="LMTPContent" runat="server" class="col-xs-">
            ...
            <div id="LMNRContainer" runat="server" class="row">
                <div id="LMNRCaption" runat="server" class="fontbold col-xs- paddingleft0">栏目显示内容</div>
                <div id="LMNRContent" runat="server" class="col-xs-">
            ...
            <div id="LMLBYSContainer" runat="server" class="row">
                <div id="LMLBYSCaption" runat="server" class="fontbold col-xs- paddingleft0">栏目列表样式</div>
                <div id="LMLBYSContent" runat="server" class="col-xs-">
            ...
            <div id="SFLBLMContainer" runat="server" class="row">
                <div id="SFLBLMCaption" runat="server" class="fontbold col-xs- paddingleft0">列表内容栏目</div>
                <div id="SFLBLMContent" runat="server" class="col-xs-">
            ...
            <div id="SFWBURLContainer" runat="server" class="row">
                <div id="SFWBURLCaption" runat="server" class="fontbold col-xs- paddingleft0">外部栏目</div>
                <div id="SFWBURLContent" runat="server" class="col-xs-">
            ...
            <div id="WBURLContainer" runat="server" class="row">
                <div id="WBURLCaption" runat="server" class="fontbold col-xs- paddingleft0">外部栏目连接</div>
                <div id="WBURLContent" runat="server" class="col-xs-">
