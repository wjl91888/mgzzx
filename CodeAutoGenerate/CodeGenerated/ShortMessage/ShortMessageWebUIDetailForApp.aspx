...
<div id="AppDetailPage">
    <asp:Repeater ID="rptDetail" runat="server">
        <ItemTemplate>
            ...
            <div id="DXXBTCaption" runat="server" class="fontbold col-xs-4 paddingleft0">标题</div>
            ...
            <div id="DXXNRCaption" runat="server" class="fontbold col-xs-4 paddingleft0">内容</div>
            ...
            <div id="DXXFJCaption" runat="server" class="fontbold col-xs-4 paddingleft0">附件</div>
            ...
            <div id="FSSJCaption" runat="server" class="fontbold col-xs-4 paddingleft0">发送时间</div>
            ...
            <div id="FSRCaption" runat="server" class="fontbold col-xs-4 paddingleft0">发送人</div>
            ...
            <div id="FSBMCaption" runat="server" class="fontbold col-xs-4 paddingleft0">发送部门</div>
            ...
            <div id="JSRCaption" runat="server" class="fontbold col-xs-4 paddingleft0">接收人</div>
