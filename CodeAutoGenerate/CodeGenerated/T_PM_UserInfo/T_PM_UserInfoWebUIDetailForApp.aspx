    ...
    <asp:Repeater ID="rptDetail" runat="server">
        <ItemTemplate>
            ...
            <div id="UserIDContainer" runat="server" class="row">
                <div id="UserIDCaption" runat="server" class="fontbold col-xs-4 paddingleft0">用户编号</div>
                <div id="UserIDContent" runat="server" class="col-xs-8">
            ...
            <div id="UserLoginNameContainer" runat="server" class="row">
                <div id="UserLoginNameCaption" runat="server" class="fontbold col-xs-4 paddingleft0">用户名</div>
                <div id="UserLoginNameContent" runat="server" class="col-xs-8">
            ...
            <div id="UserGroupIDContainer" runat="server" class="row">
                <div id="UserGroupIDCaption" runat="server" class="fontbold col-xs-4 paddingleft0">用户组</div>
                <div id="UserGroupIDContent" runat="server" class="col-xs-8">
            ...
            <div id="SubjectIDContainer" runat="server" class="row">
                <div id="SubjectIDCaption" runat="server" class="fontbold col-xs-4 paddingleft0">所属单位</div>
                <div id="SubjectIDContent" runat="server" class="col-xs-8">
            ...
            <div id="UserNickNameContainer" runat="server" class="row">
                <div id="UserNickNameCaption" runat="server" class="fontbold col-xs-4 paddingleft0">姓名</div>
                <div id="UserNickNameContent" runat="server" class="col-xs-8">
            ...
            <div id="MZContainer" runat="server" class="row">
                <div id="MZCaption" runat="server" class="fontbold col-xs-4 paddingleft0">民族</div>
                <div id="MZContent" runat="server" class="col-xs-8">
            ...
            <div id="ZZMMContainer" runat="server" class="row">
                <div id="ZZMMCaption" runat="server" class="fontbold col-xs-4 paddingleft0">政治面貌</div>
                <div id="ZZMMContent" runat="server" class="col-xs-8">
            ...
            <div id="SJHContainer" runat="server" class="row">
                <div id="SJHCaption" runat="server" class="fontbold col-xs-4 paddingleft0">手机</div>
                <div id="SJHContent" runat="server" class="col-xs-8">
            ...
            <div id="BGDHContainer" runat="server" class="row">
                <div id="BGDHCaption" runat="server" class="fontbold col-xs-4 paddingleft0">办公电话</div>
                <div id="BGDHContent" runat="server" class="col-xs-8">
            ...
            <div id="JTDHContainer" runat="server" class="row">
                <div id="JTDHCaption" runat="server" class="fontbold col-xs-4 paddingleft0">家庭电话</div>
                <div id="JTDHContent" runat="server" class="col-xs-8">
            ...
            <div id="EmailContainer" runat="server" class="row">
                <div id="EmailCaption" runat="server" class="fontbold col-xs-4 paddingleft0">Email</div>
                <div id="EmailContent" runat="server" class="col-xs-8">
            ...
            <div id="QQHContainer" runat="server" class="row">
                <div id="QQHCaption" runat="server" class="fontbold col-xs-4 paddingleft0">QQ</div>
                <div id="QQHContent" runat="server" class="col-xs-8">
            ...
            <div id="LoginTimeContainer" runat="server" class="row">
                <div id="LoginTimeCaption" runat="server" class="fontbold col-xs-4 paddingleft0">登录时间</div>
                <div id="LoginTimeContent" runat="server" class="col-xs-8">
            ...
            <div id="LastLoginIPContainer" runat="server" class="row">
                <div id="LastLoginIPCaption" runat="server" class="fontbold col-xs-4 paddingleft0">登录IP</div>
                <div id="LastLoginIPContent" runat="server" class="col-xs-8">
            ...
            <div id="LastLoginDateContainer" runat="server" class="row">
                <div id="LastLoginDateCaption" runat="server" class="fontbold col-xs-4 paddingleft0">上次时间</div>
                <div id="LastLoginDateContent" runat="server" class="col-xs-8">
            ...
            <div id="LoginTimesContainer" runat="server" class="row">
                <div id="LoginTimesCaption" runat="server" class="fontbold col-xs-4 paddingleft0">登录次数</div>
                <div id="LoginTimesContent" runat="server" class="col-xs-8">
